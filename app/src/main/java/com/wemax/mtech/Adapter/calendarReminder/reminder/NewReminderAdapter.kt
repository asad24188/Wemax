...
class NewReminderAdapter(val context: Context, val list: ArrayList<NewReminderModel>) :
RecyclerView.Adapter<NewReminderAdapter.myViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): myViewHolder {
        ...
        return NewReminderAdapter.myViewHolder(view)
    }
