...
class FindEventsAdapter(val context: Context, val booking: List<HotEventsPostModel>) :
    RecyclerView.Adapter<FindEventsAdapter.myViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): myViewHolder {
        ...
        val view: View = inflater.inflate(R.layout.item_layout_hot_events2, parent, false)
