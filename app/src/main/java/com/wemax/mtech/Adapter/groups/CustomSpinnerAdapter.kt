...
class CustomSpinnerAdapter(internal var context: Context, internal var imagesList: IntArray, internal var privacyTextStringList: Array<String>) :
    BaseAdapter() {
    ...
    override fun getView(i: Int, view: View?, viewGroup: ViewGroup): View {
        ...
        val view = inflter.inflate(R.layout.spinner_item_custom_layout,null)
