...
import com.wemax.mtech.databinding.ActivityMyAppointmentsDetailsBinding

class MyAppointmentsDetailsActivity : AppCompatActivity(), OnMapReadyCallback {
    lateinit var binding: ActivityMyAppointmentsDetailsBinding
    val contextActivity = this@MyAppointmentsDetailsActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding=ActivityMyAppointmentsDetailsBinding.inflate(layoutInflater)
